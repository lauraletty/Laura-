package com.example.linkapp.ui.theme.screens.FaintF
...
fun AddFaintScreen(navController:NavHostController){
    Column(
        ...
        ImagePicker(modifier,context, navController, instruction.trim())
...
@Composable
fun ImagePicker(modifier: Modifier = Modifier, context: Context,navController: NavHostController, Instruction:String, ) {
